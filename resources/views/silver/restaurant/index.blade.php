        ...
        <div class="dashboard-content">
            ...
            <div class="search-inputs">
                ...
                <div class="add-button-box">
                    <a class="header-inputs-red" href="{{route('restaurant.create', app()->getLocale())}}"><i class="fas fa-plus"></i> ADD RESTAURANT</a>
                </div>
...
@section('footer')
    <script>
        $(document).ready(function(){
            ...
            {
                $.ajax({
                    url:"/"+parametarSet+"/admin/restaurant/DSLvuwum9LmE2hPg?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
                    success:function(data)
                    {
                        $('tbody').html('');
                        $('tbody').html(data);
