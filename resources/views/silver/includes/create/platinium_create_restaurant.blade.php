...
<div class="tab">
    ...
    <div class="form row">
        <div class="col form-group">
            ...
            <input class="form-control check" type="time" name="opening" id="opening" oninput="this.className = 'form-control check'" placeholder="sad">
            <small class="text-muted">Example: 07:30 AM</small>
        </div>
        <div class="col form-group">
            <label for="closing">Closing Time:</label>
            <input class="form-control check" type="time" name="closing" id="closing" oninput="this.className = 'form-control check'">
