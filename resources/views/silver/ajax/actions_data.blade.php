    ...
    <tr>
        ...
        <td class="center-buttons">
            @if($action->is_active == 1)
                {!! Form::open(['method'=>'PATCH', 'action'=>['AuthorActionsController@updateActions', app()->getLocale(), $action->id]]) !!}
        ...
        <td>
            <a href="{{route('actions.edit', [app()->getLocale(), $action->id])}}" class="blue ajax-input-2" id="blue-user-admin">
                 Edit/Delete
            </a>
        </td>
    </tr>
