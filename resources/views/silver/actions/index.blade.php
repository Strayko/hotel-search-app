...
{{--            {--}}
{{--                $.ajax({--}}
{{--                    url:"/admin/actions/spy5k2YgeWYBY46X?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,--}}
        ...
        <div class="dashboard-content">
            ...
            <div class="search-inputs">
                ...
                <div class="add-button-box">
                    <a class="header-inputs-red" href="{{route('actions.create', app()->getLocale())}}"><i class="fas fa-plus"></i> ADD ACTION</a>
                </div>
                <div class="sorting-button-box">
                    <a class="header-inputs-tirkiz sorting" data-sorting_type="asc" data-column_name="id" href="#"><i class="fas fa-wallet"></i> SORTING ACTIONS</a>
                </div>
            </div>
...
@section('footer')
    <script>
        $(document).ready(function(){
            ...
            {
                $.ajax({
                    url:"/"+parametarSet+"/admin/actions/spy5k2YgeWYBY46X?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
                    success:function(data)
                    {
                        $('tbody').html('');
                        $('tbody').html(data);
