...
{{--            <div class="row">--}}
{{--                <div class="col-md-3">--}}
{{--                    <a href="/admin/event" class="btn btn-primary btn-block">--}}
...
<section id="admin2-dashboard">
    ...
    <div class="admin2-dashboard-content">
        ...
        <div class="dashboard-content">
            <select name="selectorLng" id="selectorLng" onchange="location = this.value;">
                @if($parametarExport == 'de')
                    @foreach (config('app.available_locales') as $locale)
                        <option value="{{ route(\Illuminate\Support\Facades\Route::currentRouteName(), [$locale, $events]) }}">
                            <a class="nav-link"
                               href="{{ route(\Illuminate\Support\Facades\Route::currentRouteName(), [$locale, $events]) }}"
            ...
            <a href="/{{$parametarExport}}/admin/event" class="back-button">Back</a>
            {!! Form::open(['method'=>'DELETE', 'action'=>['AuthorEventController@destroy', app()->getLocale(), $events->id]]) !!}
            ...
            <div class="create-form">
                <div class="form-left">
                    <p class="p-lead-h4">Edit event</p>

                    {!! Form::model($events, ['method'=>'PATCH', 'action'=>['AuthorEventController@update', app()->getLocale(), $events->id], 'files'=>true]) !!}
                    ...
                    <button class="create-input-button" type="submit"><i class="fas fa-calendar-alt"></i> UPDATE</button>
                </div>
