...
{{--                <a href="{{route('users.index')}}"><li class="p-lead active"><i class="fas fa-users"></i> Users</li></a>--}}
...
{{--                    <input class="search" type="text" name="serach" id="serach" placeholder="Search users ...">--}}
{{--                    <div class="add-button-box">--}}
{{--                        <a class="header-inputs-red" href="{{route('users.create')}}"><i class="fas fa-plus"></i> ADD USER</a>--}}
{{--                    </div>--}}
{{--                    <div class="sorting-button-box">--}}
{{--                        <a class="header-inputs-tirkiz sorting" data-sorting_type="asc" data-column_name="id" href="#" href="#"><i class="fas fa-users"></i> SORTING USERS</a>--}}
{{--                    </div>--}}
{{--                </div>--}}
    ...
    <section id="admin2-dashboard">
        <div class="admin2-menu">
            <ol>
                ...
                <a href="{{route('users.index', app()->getLocale())}}"><li class="p-lead active"><i class="fas fa-users"></i> Users</li></a>
...
{{--                            </div>--}}
{{--                        @endif--}}
                        <p class="p-lead-h4">Create a new user</p>

                        {!! Form::open(['method'=>'POST', 'action'=>['AdminUsersController@store', app()->getLocale()], 'files'=>true]) !!}
                        {{csrf_field()}}
                        ...
                        <button class="create-input-button" type="submit"><i class="fas fa-users"></i> CREATE</button>
                        {!! Form::close() !!}
                    </div>
