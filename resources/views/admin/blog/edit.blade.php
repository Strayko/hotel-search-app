...
@section('content')
    ...
    <header id="main-header" class="py-2 bg-light text-black">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1><i class="fab fa-blogger-b"></i> Edit Blog</h1>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                        ...
                        <button type="submit" class="btn btn-danger btn-block"><i class="fas fa-trash-alt"></i> Delete Blog</button>
                        {!! Form::close() !!}
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row d-flex justify-content-end">
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-success btn-block"><i class="fab fa-blogger-b"></i> Update Blog</button>
                                    {!! Form::close() !!}
