...
{{--                        <i class="fab fa-blogger-b"></i> Sorting Blogs--}}
{{--                    </a>--}}
{{--                </div>--}}
{{--                <div class="col-md-6 ml-auto">--}}
{{--                    <div class="form-group">--}}
{{--                        <input type="text" name="serach" id="serach" class="form-control" placeholder="Search Blogs...">--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--            {--}}
{{--                $.ajax({--}}
{{--                    url:"/admin2/blog/v88D4TpNWbL3yGQf?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,--}}
    ...
    <div class="admin2-dashboard-content">
        ...
        <div class="dashboard-content">
            <div class="search-inputs">
                ...
                <input class="search" type="text" name="serach" id="serach" placeholder="Search blog ...">
                <div class="add-button-box">
                    <a class="header-inputs-red" href="{{route('blog.create')}}"><i class="fas fa-plus"></i> ADD BLOG</a>
                </div>
                <div class="sorting-button-box">
                    <a class="header-inputs-tirkiz sorting" data-sorting_type="asc" data-column_name="id" href="#"><i class="fab fa-blogger-b"></i> SORTING BLOG</a>
                </div>
            </div>
