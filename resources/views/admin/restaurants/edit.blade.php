    ...
    <div class="admin2-dashboard-content">
        ...
        <div class="dashboard-content" id="user-admin-create-restaurant">
            ...
            <div class="create-form">
                <div class="form-left">
                    <p class="p-lead-h4">Edit restaurant</p>



                    {!! Form::model($restaurants, ['method'=>'PATCH', 'action'=>['AdminRestaurantsController@update', app()->getLocale(), $restaurants->id], 'files'=>true, 'id'=>'regForm']) !!}
                    {{csrf_field()}}
                    <div class="tab">
                    ...
                    <div class="tab">
                        ...
                        {!! Form::text('facebook', $restaurants->social->facebook, ['class'=>'create-form-input']) !!}

                        {!! Form::label('twitter', 'TWITTER', ['class'=>'label-grey-small']) !!}
                        {!! Form::text('twitter', $restaurants->social->twitter, ['class'=>'create-form-input']) !!}

                        {!! Form::label('instagram', 'INSTAGRAM', ['class'=>'label-grey-small']) !!}
                        {!! Form::text('instagram', $restaurants->social->instagram, ['class'=>'create-form-input']) !!}

                        {!! Form::label('google', 'GOOGLE PLUS', ['class'=>'label-grey-small']) !!}
                        {!! Form::text('google', $restaurants->social->google, ['class'=>'create-form-input']) !!}
                    </div>

                    <div class="tab">
                        {!! Form::label('address2', 'ADDRESS', ['class'=>'label-grey-small']) !!}
                        {!! Form::text('address2', $restaurants->contact->address2, ['class'=>'create-form-input']) !!}

                        {!! Form::label('email', 'EMAIL', ['class'=>'label-grey-small']) !!}
                        {!! Form::email('email', $restaurants->contact->email, ['class'=>'create-form-input']) !!}

                        {!! Form::label('telephone', 'TEL', ['class'=>'label-grey-small']) !!}
                        {!! Form::text('telephone', $restaurants->contact->telephone, ['class'=>'create-form-input']) !!}

                        {!! Form::label('mobile', 'MOB', ['class'=>'label-grey-small']) !!}
                        {!! Form::text('mobile', $restaurants->contact->mobile, ['class'=>'create-form-input']) !!}

                        <label for="opening" class="label-grey-small">OPENING TIME</label>
                        <input class="create-form-input check" type="time" name="opening" id="opening" oninput="this.className = 'create-form-input check'" value="{!! $restaurants->contact->opening !!}">
                        ...
                        <input class="create-form-input check" type="time" name="closing" id="closing" oninput="this.className = 'create-form-input check'" value="{!! $restaurants->contact->closing !!}">
