...
{{--                        <i class="fas fa-map-marker-alt"></i> Sorting Locations--}}
{{--                    </a>--}}
{{--                </div>--}}
{{--                <div class="col-md-6 ml-auto">--}}
{{--                    <div class="form-group">--}}
{{--                        <input type="text" name="serach" id="serach" class="form-control" placeholder="Search Locations...">--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--                            </thead>--}}
{{--                            <tbody>--}}
{{--                            @include('admin.ajax.locations_data')--}}
{{--                            </tbody>--}}
{{--                        </table>--}}
...
{{--            {--}}
{{--                $.ajax({--}}
{{--                    url:"/admin2/locations/mz8y9arxaj6qPBMP?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,--}}
    ...
    <div class="admin2-dashboard-content">
        ...
        <div class="dashboard-content">
            <div class="search-inputs">
                ...
                <input class="search" type="text" name="serach" id="serach" placeholder="Search locations ...">
                <div class="add-button-box">
                    <a class="header-inputs-red" href="{{route('locations.create')}}"><i class="fas fa-plus"></i> ADD LOCATION</a>
                </div>
                <div class="sorting-button-box">
                    <a class="header-inputs-tirkiz sorting" data-sorting_type="asc" data-column_name="id" href="#"><i class="fas fa-map-marker-alt"></i> SORTING LOCATIONS</a>
                </div>
            </div>
