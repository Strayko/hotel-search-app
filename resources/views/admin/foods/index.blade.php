...
{{--                        <i class="fas fa-pepper-hot"></i> Sorting Foods--}}
{{--                    </a>--}}
{{--                </div>--}}
{{--                <div class="col-md-6 ml-auto">--}}
{{--                    <div class="form-group">--}}
{{--                        <input type="text" name="serach" id="serach" class="form-control" placeholder="Search Foods...">--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--            {--}}
{{--                $.ajax({--}}
{{--                    url:"/admin2/foods/cSgG2EREmKrVtvqn?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,--}}
    ...
    <div class="admin2-dashboard-content">
        ...
        <div class="dashboard-content">
            <div class="search-inputs">
                ...
                <input class="search" type="text" name="serach" id="serach" placeholder="Search foods ...">
                <div class="add-button-box">
                    <a class="header-inputs-red" href="{{route('foods.create')}}"><i class="fas fa-plus"></i> ADD FOOD</a>
                </div>
                <div class="sorting-button-box">
                    <a class="header-inputs-tirkiz sorting" data-sorting_type="asc" data-column_name="id" href="#"><i class="fas fa-hamburger"></i> SORTING FOODS</a>
                </div>
            </div>
