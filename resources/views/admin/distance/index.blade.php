...
{{--                        <i class="fas fa-location-arrow"></i> Sorting Distances--}}
{{--                    </a>--}}
{{--                </div>--}}
{{--                <div class="col-md-6 ml-auto">--}}
{{--                    <div class="form-group">--}}
{{--                        <input type="text" name="serach" id="serach" class="form-control" placeholder="Search Distances...">--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--                                @include('admin.ajax.distances_data')--}}
{{--                                @else--}}
...
{{--            {--}}
{{--                $.ajax({--}}
{{--                    url:"/admin2/distance/6bHgNQGUJvBTRz47?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,--}}
...
<section id="admin2-dashboard">
    ...
    <div class="admin2-dashboard-content">
        <div class="dashboard-header">
            <i class="fab fa-font-awesome-flag"></i><h2>Distance</h2>
        ...
        <div class="dashboard-content">
            <div class="search-inputs">
                ...
                <input class="search" type="text" name="serach" id="serach" placeholder="Search distance ...">
                <div class="add-button-box">
                    <a class="header-inputs-red" href="{{route('distance.create')}}"><i class="fas fa-plus"></i> ADD DISTANCE</a>
                </div>
                <div class="sorting-button-box">
                    <a class="header-inputs-tirkiz sorting" data-sorting_type="asc" data-column_name="id" href="#"><i class="fab fa-font-awesome-flag"></i> SORTING DISTANCES</a>
                </div>
            </div>
